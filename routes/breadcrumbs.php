...
Breadcrumbs::for('admin.create.category.attribute', function ($trail) {
    $trail->parent('admin.dashboard');
    $trail->push(__('messages.price_variables_management'), route('admin.category.attribute.index'));
});

// create category attribute value
Breadcrumbs::for('admin.create.category.attribute.value', function ($trail,$title) {
    $trail->parent('admin.dashboard');
    $trail->push(__('messages.price_variables_list'),route('admin.category.attribute.index'));
    $trail->push($title);
});
