...
<!-- Favicon -->
 ...
 <link rel="stylesheet" href="{{ asset('front_assets/css/plugins/owl-carousel/owl.carousel.css') }}">
 <link rel="stylesheet" href="{{ asset('front_assets/css/plugins/magnific-popup/magnific-popup.css') }}">
 <link rel="stylesheet" href="{{ asset('front_assets/css/plugins/jquery.countdown.css') }}">
 <!-- Main CSS File -->
 <link rel="stylesheet" href="{{ asset('front_assets/css/style.css') }}">
 <link rel="stylesheet" href="{{ asset('front_assets/css/skins/skin-demo-29.css') }}">
 <link rel="stylesheet" href="{{ asset('front_assets/css/demos/demo-29.css')}} ">
