    ...
    <div class="container-fluid">
        ...
        <div class="row d-flex justify-content-start my-4 bg-white">
            <div class="col-lg-4 col-md-4 col  my-5  border-bottom title-add-to-stock">
                <div class="alert my-4">
                    <h3>{{ __('messages.suggestion_banner') }} / {{ __('messages.add_new_suggest') }}</h3>
                </div>
            </div>
        </div>
        ...
        <div class="row my-4 bg-white">
            <div class="col-lg-4 col-md-4 col my-2">
                <a href="{{ route('admin.suggestion.products.index') }}"
                   class="btn btn-sm btn-primary">{{ __('messages.list_of_suggestions') }}</a>
            </div>
        </div>

        <livewire:admin.product-suggestion-list.products/>


        {{-- <form action="{{ route('admin.suggestion.products.store') }}" method="post" enctype="multipart/form-data">
             @csrf
                     ...
                     <div class="row mt-4 d-flex flex-column justify-content-center align-content-center">
                         ...
                         <div class="col-lg-5">
                             ...
                             <input type="file" class="form-control"
                                    accept="image/png, image/jpeg , image/jpg ,image/gif" id="image_select"
                                    name="image_path">
                             @error('image_path')
                             <div class="alert alert-danger mt-3">
                                 {{ $message }}
