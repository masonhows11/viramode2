												...
												<div class="menu-sub menu-sub-lg-down-accordion menu-sub-lg-dropdown menu-active-bg px-lg-2 py-lg-4 w-lg-225px">
													...
													<div class="menu-item">
														...
														<a class="menu-link" href="../../demo1/dist/apps/inbox/reply.html">
															...
															<span class="menu-title">پاسخ</span>
														</a>
														<!--end:Menu link-->
													</div>
													<!--end:Menu item-->
							...
							<div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
								...
								<div id="kt_app_toolbar_container" class="app-container container-fluid d-flex flex-stack">
									...
									<div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
										<!--begin::Title-->
										<h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">چند منظوره</h1>
										<!--end::Title-->
										<!--begin::Breadcrumb-->
											...
											<div class="card card-flush h-md-50 mb-5 mb-xl-10">
												...
												<div class="card-header pt-5">
													...
													<div class="card-title d-flex flex-column">
														...
														<div class="d-flex align-items-center">
															<!--begin::واحد پول-->
															<span class="fs-4 fw-semibold text-gray-400 me-1 align-self-start">ت</span>
															<!--end::واحد پول-->
															<!--begin::مقدار-->
														...
														<!--end::Info-->
														<!--begin::Subtitle-->
														<span class="text-gray-400 pt-1 fw-semibold fs-6">پروژه ها درآمد</span>
														<!--end::Subtitle-->
													</div>
													<!--end::Title-->
												</div>
														...
														<div class="tab-pane fade" id="kt_chart_widget_8_week_tab" role="tabpanel">
															...
															<div class="mb-5">
																...
																<div class="d-flex align-items-center mb-2">
																	<span class="fs-1 fw-semibold text-gray-400 me-1 mt-n1">ت</span>
																		...
																		<tr>
																			<td>
																				<div class="d-flex align-items-center">
																					...
																					<div class="d-flex justify-content-start flex-column">
																						<a href="../../demo1/dist/pages/user-profile/overview.html" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">جین کوپر</a>
																		...
																		<tr>
																			<td>
																				<div class="d-flex align-items-center">
																					...
																					<div class="d-flex justify-content-start flex-column">
																						<a href="../../demo1/dist/pages/user-profile/overview.html" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">ماروین مک کینی</a>
																						<span class="text-gray-400 fw-semibold d-block fs-7">فرانسه</span>
																					</div>
																				</div>
																			</td>
																		...
																		<tr>
																			<td>
																				<div class="d-flex align-items-center">
																					...
																					<div class="d-flex justify-content-start flex-column">
																						<a href="../../demo1/dist/pages/user-profile/overview.html" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">جواد یساری</a>
																						<span class="text-gray-400 fw-semibold d-block fs-7">نیورک</span>
																					</div>
																				</div>
																			</td>
																			<td class="text-end pe-13">
																		...
																		<tr>
																			<td>
																				<div class="d-flex align-items-center">
																					...
																					<div class="d-flex justify-content-start flex-column">
																						<a href="../../demo1/dist/pages/user-profile/overview.html" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">لزلی الکساندر</a>
																		...
																		<tr>
																			<td>
																				<div class="d-flex align-items-center">
																					...
																					<div class="d-flex justify-content-start flex-column">
																						<a href="../../demo1/dist/pages/user-profile/overview.html" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">ماروین مک کینیr</a>
																						<span class="text-gray-400 fw-semibold d-block fs-7">فرانسه</span>
																					</div>
																				</div>
																			</td>
																		...
																		<tr>
																			<td>
																				<div class="d-flex align-items-center">
																					...
																					<div class="d-flex justify-content-start flex-column">
																						<a href="../../demo1/dist/pages/user-profile/overview.html" class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">استر هوارد</a>
																						<span class="text-gray-400 fw-semibold d-block fs-7">ایساند</span>
																					</div>
																				</div>
																			</td>
																			<td class="text-end pe-13">
											...
											<div class="card card-flush h-md-100">
												...
												<div class="card-header pt-5 mb-6">
													...
													<h3 class="card-title align-items-start flex-column">
														...
														<div class="d-flex align-items-center mb-2">
															<!--begin::واحد پول-->
															<span class="fs-3 fw-semibold text-gray-400 align-self-start me-1">ت</span>
															<!--end::واحد پول-->
															<!--begin::Value-->
														...
														<!--end::امار-->
														<!--begin::توضیحات-->
														<span class="fs-6 fw-semibold text-gray-400">درآمد نماینده</span>
														<!--end::توضیحات-->
													</h3>
													<!--end::Title-->
													<!--begin::Toolbar-->
																	...
																	<td>
																		<div class="d-flex align-items-center">
																			...
																			<div class="d-flex justify-content-start flex-column">
																				...
																				<span class="text-gray-400 fw-semibold d-block fs-7">جین کوپر</span>
																			</div>
																		</div>
																	</td>
																	<td class="text-end pe-0">
											...
											<div class="card card-flush h-xl-100">
												...
												<div class="card-header pt-7 mb-7">
													...
													<h3 class="card-title align-items-start flex-column">
														...
														<span class="text-gray-400 mt-1 fw-semibold fs-6">8 هزار بازدید اجتماعی</span>
													</h3>
													<!--end::Title-->
													<!--begin::Toolbar-->
													<div class="card-toolbar">
														<a href="../../demo1/dist/apps/ecommerce/catalog/add-product.html" class="btn btn-sm btn-light">گزارش PDF</a>
													</div>
													<!--end::Toolbar-->
												</div>
												<!--end::Header-->
												...
												<div class="card-body d-flex align-items-end pt-0">
													<!--begin::Chart-->
													<div id="kt_charts_widget_31_chart" class="w-100 h-300px" style="direction: ltr"></div>
													<!--end::Chart-->
												</div>
												<!--end::Body-->
											</div>
											...
											<div class="card card-flush overflow-hidden h-xl-100">
												...
												<div class="card-header py-5">
													...
													<h3 class="card-title align-items-start flex-column">
														...
														<span class="text-gray-400 mt-1 fw-semibold fs-6">گزارشات توسط ایالت ها و گاندرها</span>
													</h3>
													<!--end::Title-->
													<!--begin::Toolbar-->
													<div class="card-toolbar">
												...
												<div class="card-body pt-0">
													<!--begin::Chart-->
													<div id="kt_charts_widget_24" class="min-h-auto" style="height: 300px;direction: ltr"></div>
													<!--end::Chart-->
												</div>
												<!--end::کارت body-->
											</div>
										...
										<label class="nav-link btn btn-outline btn-outline-dashed btn-color-dark btn-active btn-active-primary d-flex flex-stack text-start p-6 active mb-6" data-bs-toggle="tab" data-bs-target="#kt_upgrade_plan_startup">
											...
											<div class="d-flex align-items-center me-2">
												...
												<div class="flex-grow-1">
													...
													<div class="fw-semibold opacity-75">بهترین برای استارت آپ ها</div>
												</div>
												<!--end::Info-->
											</div>
											<!--end::توضیحات-->
