...
@section('admin_main')
    ...
    <div class="container-fluid">
        ...
        <div class="row d-flex justify-content-start my-4 bg-white">
            <div class="col-lg-4 col-md-4 col  my-5  border-bottom title-add-to-stock">
                <div class="alert my-4">
                    <h3>{{ __('messages.new_email_notice') }} </h3>
                </div>
            </div>
        </div>
        ...
        <form action="{{ route('admin.email.notices.store') }}" method="post">
            @csrf
            <div class="row create-email-notice my-4 bg-white">
                ...
                <div class="col-sm-4 mt-2">
                    <div class="">
                        ...
                        <input type="text" id="subject"
                               class="form-control @error('subject') is-invalid @enderror form-control-lg"
                ...
                <div class="col-12 mt-5">
                    ...
                    <textarea class="form-control" rows="8" dir="rtl" name="body" id="email-body">{{ old('body') }}</textarea>
                    @error('body')
                    <div class="alert alert-danger mt-2">
                        {{ $message }}
                    </div>
