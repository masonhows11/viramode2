        ...
        <div class="row d-flex justify-content-start my-4 bg-white">
            <div class="col-lg-4 col-md-4 col  my-5  border-bottom title-add-to-stock">
                <div class="alert my-4">
                    <h3>{{ __('messages.edit_email_notice') }} </h3>
                </div>
            </div>
        </div>
        <div class="row my-4 bg-white">
            <div class="col-lg-4 col-md-4 col my-2">
                <a href="{{ route('admin.email.notices.index') }}"
                   class="btn btn-sm btn-primary">{{ __('messages.notices_list') }}</a>
            </div>
        </div>
            ...
            <div class="row create-email-notice my-4 bg-white">
                ...
                <div class="col-sm-4 mt-2">
                    <div class="">
                        ...
                        <input type="text" id="published_at_view" class="form-control form-control-lg" value="{{ $notice->published_at }}">
                    </div>
                    @error('published_at')
                    <div class="alert alert-danger mt-2">
                        {{ $message }}
