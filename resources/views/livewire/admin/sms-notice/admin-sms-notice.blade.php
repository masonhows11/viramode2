<div>
    <div class="container-fluid">
        ...
        <div class="row d-flex justify-content-start my-4 bg-white">
            <div class="col-lg-4 col-md-4 col  my-5  border-bottom title-add-to-stock">
                <div class="alert my-4">
                    <h3>{{ __('messages.sms_notification') }}</h3>
                </div>
            </div>
        </div>
        ...
        <div class="row  sms-notice-list bg-white mb-4 overflow-auto" style="height: 320px">
            <div class="my-5">
                ...
                <table class="table table-striped">
                    ...
                    @foreach( $notices as $notice)
                        <tr class="text-center">
                            ...
                            <td><a href="{{ route('admin.notices.send.sms',$notice->id) }}" class="btn btn-sm btn-primary">{{ __('messages.send_message') }}</td>
                            <td>
                            ...
                            <td>
                                <div class="mt-2">
                                    ...
                                    <a href="{{ route('admin.sms.notices.edit',$notice->id) }}" class="ms-2"><i class="fa fa-edit"></i></a>
                                </div>
                            </td>
                        </tr>
                    @endforeach
